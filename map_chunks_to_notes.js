 ...
 */
function mapChunksToNotes(chunks, numNotes) {
    var a = [];
    var origMax = chunks.length - 1;
    var destMax = numNotes - 1;
...
/*
 * If this is running under Max, export mapChunksToNotes into the global
 * namespace.
 */
if (Global) {
    var util = new Global('util');
    util.mapChunksToNotes = mapChunksToNotes;
}
...
arr = mapChunksToNotes([[1, 10], [11, 20], [21, 30], [31, 40]], 2);
console.log(JSON.stringify(arr));

arr = mapChunksToNotes(
    [[1, 10], [11, 20], [21, 30], [31, 40], [41, 50], [51, 60], [61, 70]],
    4
);
console.log(JSON.stringify(arr));

arr = mapChunksToNotes([[1, 10], [11, 20], [21, 30], [31, 40]], 5);
console.log(JSON.stringify(arr));
